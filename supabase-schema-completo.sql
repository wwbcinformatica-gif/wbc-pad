-- WBC NotePad - Supabase Schema Completo
...
-- INSERT INTO profiles (id, email, name, role, subscription_status) VALUES (gen_random_uuid(), 'admin@wbc.com', 'Admin', 'admin', 'active');